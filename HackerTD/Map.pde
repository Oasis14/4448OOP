class Map {
  ...
  Map (int bH, int backg) {
    ...
    this.protoCreeps.put("basicCreep5", new Creep("images/basicCreep.png", 150, 7));
    this.protoCreeps.put("basicCreep6", new Creep("images/basicCreep2.png", 300, 4));
    this.protoCreeps.put("basicCreep7", new Creep("images/basicCreep.png", 200, 8));
    this.protoCreeps.put("basicCreep8", new Creep("images/basicCreep2.png", 400, 4));
    this.protoCreeps.put("basicCreep9", new Creep("images/basicCreep.png", 250, 9));
    this.protoCreeps.put("basicCreep10", new Creep("images/basicCreep2.png", 500, 4));
    this.protoCreeps.put("basicCreep11", new Creep("images/basicCreep.png", 300, 10));
    this.protoCreeps.put("basicCreep12", new Creep("images/basicCreep2.png", 600, 4));
    this.protoCreeps.put("basicCreep13", new Creep("images/basicCreep.png", 500, 10));
    this.protoCreeps.put("basicCreep14", new Creep("images/basicCreep2.png", 1000, 4));
    this.protoCreeps.put("boss", new Creep("images/basicCreep2.png", 20000, 2));
